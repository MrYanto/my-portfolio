...
const Hero = () => {
  return (
    <section
      className='flex min-h-dvh flex-col justify-between lg:flex-row-reverse'
      id='hero'
    >
      {/* Background */}
      ...
      <div className='flex max-w-[684px] flex-7 basis-80 flex-col gap-8 lg:translate-y-[227px] lg:gap-[62px]'>
        {/* Text */}
